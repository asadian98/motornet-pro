...
#grid(
  ...
  align(center+horizon)[
    ...
    caption: [#link("motornet")[MotorNet] plant @MotorNet]) <motornet_plant>
  ],
  grid(
    columns: 1,
    rows: (3cm, 3cm),
...
#align(center)[
#figure(image("./assets/motornet_pro_layout.png", width: 50%), 
caption: [#smallcaps[MotorNet-Pro] layout, adapted from @MotorNet]) <motornet_pro_layout>
]
